...
excel_file = 'https://github.com/lucasrdrz/Prueba/blob/main/ENCUESTA%20EPS.xlsx?raw=true'
...
df_personas = df.groupby(['EPS'], as_index = False)['EDAD PERSONA ENCUESTADA'].count() #hago un tipo de TABLA DINAMICA para agrupar los datos de una mejor
 #manera, lo que hago aqui es que por cada EPS, me cuente la cantidad de personas encuestadas***
